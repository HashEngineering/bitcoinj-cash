 ...
 */
     ...
     */
    static byte [] cat(final byte [] x , final byte [] y) {
    ...
    static long polyMod(final byte [] v) {
        /**
    ...
    static byte [] createChecksum(String prefix, final byte [] payload) {
         ...
         */
        public static Pair<String, byte []> decode(String str, String defaultPrefix) {
    ...
    static public byte [] packAddrData(byte [] payload, byte type) {
